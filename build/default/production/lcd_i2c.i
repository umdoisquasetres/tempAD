...
# 4 "lcd_i2c.c" 2
# 17 "lcd_i2c.c"
static uint8_t backlight_status = (1 << 3);
...
void LCD_Write_I2C(uint8_t data) {
    ...
    if (I2C_Write(data | backlight_status)) {
        I2C_Stop();
        return;
    }
    I2C_Stop();
...
void LCD_SendData(uint8_t data) {
    LCD_Write_Nibble(data & 0xF0, (1 << 0));
    LCD_Write_Nibble((data << 4) & 0xF0, (1 << 0));
}
